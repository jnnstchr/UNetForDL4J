...
public class UNetNoTransfer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        graph.addInputs("input").setInputTypes(InputType.convolutional3D(Convolution3D.DataFormat.NCDHW,un.inputShape[0],un.inputShape[1],un.inputShape[2],un.inputShape[3]));
    ...
    private int[] inputShape = new int[] {3,512, 512, 1};
